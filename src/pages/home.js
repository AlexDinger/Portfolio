    ...
    <Page>
      <div className="md:space-y-0 space-y-5">
        ...
        <p>
          ...
          working out of New Jersey. I enjoy taking on new and complex problems
          and learning new technologies along the way. Currently I am working on
          a fully featured vacation planner for large groups.
        </p>
        <p>
      ...
      <div className="md:space-y-0 space-y-5 w-full">
        ...
        <Link
          to="/projects"
          className="w-full py-3 block text-center bg-gray-700 rounded-sm hover:bg-gray-800"
        >
          See More
        </Link>
      </div>
